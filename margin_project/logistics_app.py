...
def run_logistics_app():
    ...
    st.markdown(
        """
        <style>
        /* Уникальный контейнер для логистического калькулятора */
        .logistics-container {
    ...
    # Оборачиваем весь интерфейс в контейнер с уникальным классом
    st.markdown("<div class='logistics-container'>", unsafe_allow_html=True)

    st.markdown("<h1>Калькулятор логистики</h1>", unsafe_allow_html=True)
