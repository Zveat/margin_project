...
def run_logistics_service():
    ...
    city_data = [
        ...
        {"Вид транспорта": "Бортовой грузовик",  "Вес груза": 6000, "Длиннa груза": 7,  "Стоимость доставки": "20000-30000"},
        {"Вид транспорта": "Фура",               "Вес груза": 23000,"Длиннa груza": 12, "Стоимость доставки": "50000-60000"}
    ]
